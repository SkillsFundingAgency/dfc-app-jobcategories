...
namespace DFC.App.JobCategories.IntegrationTests.ControllerTests.RobotControllerTests
{
    [Trait("Category", "Integration")]
    public class RobotControllerRouteTests : IClassFixture<CustomWebApplicationFactory<DFC.App.JobCategories.Startup>>
    {
        private readonly CustomWebApplicationFactory<DFC.App.JobCategories.Startup> factory;

        public RobotControllerRouteTests(CustomWebApplicationFactory<DFC.App.JobCategories.Startup> factory)
        {
