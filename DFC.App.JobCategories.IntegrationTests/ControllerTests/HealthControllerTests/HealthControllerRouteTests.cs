...
namespace DFC.App.JobCategories.IntegrationTests.ControllerTests.HealthControllerTests
{
    [Trait("Category", "Integration")]
    public class HealthControllerRouteTests : IClassFixture<CustomWebApplicationFactory<DFC.App.JobCategories.Startup>>
    {
        private readonly CustomWebApplicationFactory<DFC.App.JobCategories.Startup> factory;

        public HealthControllerRouteTests(CustomWebApplicationFactory<DFC.App.JobCategories.Startup> factory)
        {
