...
namespace DFC.App.JobCategories.IntegrationTests.ControllerTests.SitemapControllerTests
{
    [Trait("Category", "Integration")]
    public class SitemapControllerRouteTests : IClassFixture<CustomWebApplicationFactory<DFC.App.JobCategories.Startup>>
    {
        private readonly CustomWebApplicationFactory<DFC.App.JobCategories.Startup> factory;

        public SitemapControllerRouteTests(CustomWebApplicationFactory<DFC.App.JobCategories.Startup> factory)
        {
