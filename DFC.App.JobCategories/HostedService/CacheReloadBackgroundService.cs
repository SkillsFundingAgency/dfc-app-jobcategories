...
namespace DFC.App.JobCategories.HostedService
{
    ...
    public class CacheReloadBackgroundService : BackgroundService
    {
        ...
        public CacheReloadBackgroundService(IHostedServiceTelemetryWrapper hostedServiceTelemetryWrapper, ILogger<CacheReloadBackgroundService> logger, CmsApiClientOptions cmsApiClientOptions, ICacheReloadService cacheReloadService)
        {
